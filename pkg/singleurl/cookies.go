...
type cookieProvider struct {
	...
	rand        *rand.Rand
	fetchFn     func(ctx context.Context, client *feishusdk.Client, tableURL, platform string) ([]feishusdk.CookieRow, error)
...
func NewCookieProvider(client *feishusdk.Client, tableURL, platform string, ttl time.Duration) (CookieProvider, error) {
	if client == nil {
...
func (p *cookieProvider) defaultFetch(ctx context.Context, client *feishusdk.Client, tableURL, platform string) ([]feishusdk.CookieRow, error) {
...
func (p *cookieProvider) defaultMarkInvalid(ctx context.Context, recordID string) error {
	...
	return p.client.UpdateCookieStatus(ctx, p.tableURL, recordID, feishusdk.CookieStatusInvalid, nil)
}
...
func isCookieValidationEnabled() bool {
	cookieValidationOnce.Do(func() {
		cookieValidationFlag = env.Bool("ENABLE_COOKIE_VALIDATION", false)
	})
