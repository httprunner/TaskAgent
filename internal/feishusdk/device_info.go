...
func DeviceFieldsFromEnv() DeviceFields {
	...
	if v := env.String(EnvDeviceFieldSerial, ""); v != "" {
		f.DeviceSerial = v
	}
	if v := env.String(EnvDeviceFieldOSType, ""); v != "" {
		f.OSType = v
	}
	if v := env.String(EnvDeviceFieldOSVersion, ""); v != "" {
		f.OSVersion = v
	}
	if v := env.String(EnvDeviceFieldIPLocation, ""); v != "" {
		f.IPLocation = v
	}
	if v := env.String(EnvDeviceFieldIsRoot, ""); v != "" {
		f.IsRoot = v
	}
	if v := env.String(EnvDeviceFieldProviderUUID, ""); v != "" {
		f.ProviderUUID = v
	}
	if v := env.String(EnvDeviceFieldAgentVersion, ""); v != "" {
		f.AgentVersion = v
	}
	if v := env.String(EnvDeviceFieldStatus, ""); v != "" {
		f.Status = v
	}
	if v := env.String(EnvDeviceFieldLastSeenAt, ""); v != "" {
		f.LastSeenAt = v
	}
	if v := env.String(EnvDeviceFieldLastError, ""); v != "" {
		f.LastError = v
	}
	if v := env.String(EnvDeviceFieldTags, ""); v != "" {
		f.Tags = v
	}
	if v := env.String(EnvDeviceFieldRunningTask, ""); v != "" {
		f.RunningTask = v
	}
	if v := env.String(EnvDeviceFieldPendingTasks, ""); v != "" {
		f.PendingTasks = v
	}
	return f
}
